...
import { Column } from "../management/page";
  ...
  if (isDragging) {
    return (
      <div
        ref={setNodeRef}
        style={style}
        className="border-2 border-rose-500 opacity-40 w-[350px] h-[500px] rounded-md flex flex-col"
      >
        Hello World
      </div>
    );
  ...
  return (
    ...
    >
      ...
      <div className="flex flex-grow flex-col gap-4 p-2 overflow-x-hidden overflow-y-auto">
        <SortableContext items={contactsIds}>
